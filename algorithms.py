...
def elliptic_curve_factorization(x,y, N, a):
    i=1
    Px = x
    Py = y
...
elliptic_curve_factorization(2,12, 26167, 4)
elliptic_curve_factorization(1,1, 1386493, 3)
elliptic_curve_factorization(7,4, 28102844557, 18)
